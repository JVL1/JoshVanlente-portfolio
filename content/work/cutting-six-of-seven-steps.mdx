...
title: "Cutting six of seven steps made photos 50% cheaper and leasing 9% faster"
summary: "An automated research loop showed my seven-step photo pipeline was obsolete. Collapsing it to one generative pass held quality at 50% lower cost, and made room for tenant item removal and virtual staging."
...
cover: "./cutting-six-of-seven-steps/cover.webp"
draft: false
---

A year ago I published a [case study](/work/deterministic-ai-photo-pipeline) arguing that the best thing about my real-estate photo pipeline was its seven modular steps. Newer models and an automated research loop have since cut those seven steps to one, which made room for two things we couldn't fit before: removing tenant belongings from a photo, and virtually staging an empty room.
...
![Before and after: the analysis stays the same, the generation collapses from up to seven chained passes into one](/images/blog/pipeline-drift/generative-passes.webp)
...
![Passes per photo: up to nine under the old design, three today](/images/blog/pipeline-drift/drift-budget.webp)
...
![An occupied living room before and after one item-removal pass](/images/blog/pipeline-drift/declutter-comparison.webp)
...
![An empty living room before and after one virtual-staging pass](/images/blog/pipeline-drift/staging-comparison.webp)
