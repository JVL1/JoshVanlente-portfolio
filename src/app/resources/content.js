...
const home = {
    ...
    - Led as a player-coach while scaling Azibo from few thousand users to tens of thousands, expanding from 1 to 7 products, and significantly improving margins.<br/>
