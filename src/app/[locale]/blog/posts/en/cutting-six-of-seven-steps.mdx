...
![Before and after: the analysis stays the same, the generation collapses from up to seven chained passes into one](/images/blog/pipeline-drift/generative-passes.svg)
...
![Passes per photo: up to nine under the old design, three today](/images/blog/pipeline-drift/drift-budget.svg)
